...
if(WIN32)
    set(USD_arch_DEPENDENCIES Ws2_32.lib;Dbghelp.lib)
else()
    set(USD_arch_DEPENDENCIES dl;m)
endif()
...
if(WIN32)
    set(USD_tf_DEPENDENCIES arch;python;Shlwapi.lib;TBB::tbb;Python3::Python)
else()
...
set(USD_usdImaging_DEPENDENCIES gf;tf;plug;trace;vt;work;geomUtil;hd;hdar;hio;pxOsd;sdf;usd;usdGeom;usdLux;usdRender;usdShade;usdVol;ar;TBB::tbb)
set(USD_usdLux_DEPENDENCIES tf;vt;sdf;sdr;usd;usdGeom;usdShade)
...
set(USD_usdUtils_DEPENDENCIES arch;tf;gf;sdf;usd;usdGeom;usdShade;TBB::tbb)
