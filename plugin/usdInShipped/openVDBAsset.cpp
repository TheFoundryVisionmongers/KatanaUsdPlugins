...
USDKATANA_USDIN_PLUGIN_DEFINE(UsdInCore_OpenVDBAssetOp, privateData, opArgs, interface)
{
    UsdKatanaAttrMap attrs;

    const UsdPrim& prim = privateData.GetUsdPrim();

    UsdKatanaReadOpenVDBAsset(UsdVolOpenVDBAsset(prim), privateData, attrs);
