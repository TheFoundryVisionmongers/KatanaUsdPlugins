...
//
#ifndef USDKATANA_READVOLUME_H
#define USDKATANA_READVOLUME_H
...
USDKATANA_API void UsdKatanaReadVolume(const UsdVolVolume& volume,
                                       const UsdKatanaUsdInPrivateData& data,
                                       UsdKatanaAttrMap& attrs);

PXR_NAMESPACE_CLOSE_SCOPE

#endif  // USDKATANA_READVOLUME_H
