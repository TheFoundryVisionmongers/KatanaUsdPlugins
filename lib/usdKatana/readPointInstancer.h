...
//
#ifndef USDKATANA_READPOINTINSTANCER_H
...
USDKATANA_API void UsdKatanaReadPointInstancer(const UsdGeomPointInstancer& instancer,
...
#endif  // USDKATANA_READPOINTINSTANCER_H
